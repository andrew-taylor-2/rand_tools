...
ind=strfind(outmsg,'--vxl=');
vxl_addendum=strrep(outmsg(ind:ind+7),' ',''); %this will fail if mask dim 4 is 100 or more entries; this is a hitherto unencountered case so if you come across it think of something a little more clever for this section, big lol 

randomise_cmd_addendum=[' --vxf=' outbasename ' ' vxl_addendum];
